    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-[#D9723F] text-white hover:bg-[#C4622F] rounded-[14px]": variant === "primary",
            "bg-white border border-[#E8E4DC] text-[#1C1917] hover:bg-[#F5F3EF] rounded-[14px]": variant === "secondary",
            "text-[#78716C] hover:text-[#1C1917] hover:bg-[#F5F3EF] rounded-[10px]": variant === "ghost",
